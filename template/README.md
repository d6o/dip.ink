...
- `.github/workflows/` — the curator (hourly), synthesis (weekly), review-queue (daily) agents. All three share concurrency group `memory-repo-writer` and run `ghcr.io/d6o/dip.ink/pi-runner:v0.1.2`.
